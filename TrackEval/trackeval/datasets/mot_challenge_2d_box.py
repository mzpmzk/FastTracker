...
class MotChallenge2DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            'CLASSES_TO_EVAL': ['person', 'bus_small', 'bus_big', 'truck_small', 
                                'truck_big', 'car', 'bike', 'motorbike', 'ignore_region',
                                'tractor', 'trailor', 'wheelchair', 'heaavy_equipment', 
                                'pm', 'umbrella'],  # Valid: ['pedestrian']
    ...
    def __init__(self, config=None):
        ...
        self.valid_classes = ['person', 'bus_small', 'bus_big', 'truck_small', 
                                'truck_big', 'car', 'bike', 'motorbike', 'ignore_region',
                                'tractor', 'trailor', 'wheelchair', 'heaavy_equipment', 
                                'pm', 'umbrella']
        ...
        self.class_name_to_class_id = {'person':1, 'bus_small':2, 'bus_big':3, 'truck_small':4, 
                                'truck_big':5, 'car':6, 'bike':7, 'motorbike':8, 'ignore_region':9,
                                'tractor':10, 'trailor':11, 'wheelchair':12, 'heaavy_equipment':13, 
                                'pm':14, 'umbrella':15}
