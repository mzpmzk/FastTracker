...
class Exp(MyExp):
    def __init__(self):
        ...
        self.input_size = (800, 1440) # for yolo_x_mot17 pretrained model
        self.test_size = (800, 1440) # for yolo_x_mot17 pretrained model
    ...
    def get_eval_loader(self, batch_size, is_distributed, testdev=False):
        ...
        valdataset = MOTDataset(
            data_dir=os.path.join(get_yolox_datadir(), "MOT15"),
